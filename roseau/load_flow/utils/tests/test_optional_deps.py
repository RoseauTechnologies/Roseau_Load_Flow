...
from roseau.load_flow.utils import optional_deps
...
def test_optional_deps(monkeypatch):
    ...
    networkx = optional_deps.networkx
    assert networkx.__class__.__name__ == "module"

    # Fail
    with pytest.raises(AttributeError) as e:
        optional_deps.toto  # noqa: B018
    assert e.value.args[0] == "module roseau.load_flow.utils.optional_deps has no attribute 'toto'"
    ...
    with monkeypatch.context() as m:
        ...
        with pytest.raises(RoseauLoadFlowException) as e:
            optional_deps.pyplot  # noqa: B018
        assert (
        ...
        with pytest.raises(RoseauLoadFlowException) as e:
            optional_deps.networkx  # noqa: B018
        assert (
