...
def to_markdown(df: pd.DataFrame, *, floatfmt: str = "g", index: bool = True, no_wrap_index: bool = False) -> str:
    ...
    Examples:
        ...
        >>> print(to_markdown(en.res_buses_voltages.reset_index(), index=False))
        ...
        |:-----------------------------------------------|:---------------|:----------------| ...
        | <nobr>FT 100kVA 15/20kV(20) 400V Dyn11</nobr>  | France Transfo |                 | ...
        | <nobr>FT 160kVA 15/20kV(20) 400V Dyn11</nobr>  | France Transfo |                 | ...
