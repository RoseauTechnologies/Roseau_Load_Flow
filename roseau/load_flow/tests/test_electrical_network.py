...
def test_unconnected_elements():
    ...
    assert (
        e.value.msg == "The elements [[Bus('b4'), Bus('b3'), Line('l2')] are not electrically connected to the network."
    )
    assert e.value.code == RoseauLoadFlowExceptionCode.UNCONNECTED_ELEMENT
