...
def test_v0_to_v1_converter(monkeypatch):
    ...
    # Branches
    tp = {
        "160kVA_Dd0": TransformerParameters.from_tests(
            id="160kVA_Dd0",
            type="dd0",
            sn=160000.0,
            uhv=20000.0,
        ...
        "160kVA_Dd6": TransformerParameters.from_tests(
            id="160kVA_Dd6",
            type="dd6",
            sn=160000.0,
            uhv=20000.0,
        ...
        "160kVA_Dyn11": TransformerParameters.from_tests(
            id="160kVA_Dyn11",
            type="dyn11",
            sn=160000.0,
            uhv=20000.0,
        ...
        "160kVA_Dyn5": TransformerParameters.from_tests(
            id="160kVA_Dyn5",
            type="dyn5",
            sn=160000.0,
            uhv=20000.0,
        ...
        "160kVA_Dzn0": TransformerParameters.from_tests(
            id="160kVA_Dzn0",
            type="dzn0",
            sn=160000.0,
            uhv=20000.0,
        ...
        "160kVA_Dzn6": TransformerParameters.from_tests(
            id="160kVA_Dzn6",
            type="dzn6",
            sn=160000.0,
            uhv=20000.0,
        ...
        "160kVA_Yd11": TransformerParameters.from_tests(
            id="160kVA_Yd11",
            type="yd11",
            sn=160000.0,
            uhv=20000.0,
        ...
        "160kVA_Yd5": TransformerParameters.from_tests(
            id="160kVA_Yd5",
            type="yd5",
            sn=160000.0,
            uhv=20000.0,
        ...
        "160kVA_Yyn0": TransformerParameters.from_tests(
            id="160kVA_Yyn0",
            type="yyn0",
            sn=160000.0,
            uhv=20000.0,
        ...
        "160kVA_Yyn6": TransformerParameters.from_tests(
            id="160kVA_Yyn6",
            type="yyn6",
            sn=160000.0,
            uhv=20000.0,
        ...
        "160kVA_Yzn11": TransformerParameters.from_tests(
            id="160kVA_Yzn11",
            type="yzn11",
            sn=160000.0,
            uhv=20000.0,
        ...
        "160kVA_Yzn5": TransformerParameters.from_tests(
            id="160kVA_Yzn5",
            type="yzn5",
            sn=160000.0,
            uhv=20000.0,
