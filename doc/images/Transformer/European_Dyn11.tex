...
\begin{document}
    ...
    \begin{tikzpicture}[%
        ...
        \node[above] at (TX.north) {$\dfrac{n_2}{n_1}$};%
        ...
        \node[above] at (TY.north) {$\dfrac{n_2}{n_1}$};%
        ...
        \node[above] at (TZ.north) {$\dfrac{n_2}{n_1}$};%
        ...
        to[short] node[near start,above=0.25cm,circ] {} (TY);%
        \draw (16,\yym) to[short,*-] (\xtransformerp,\yym) to[short] (TY);%
        ...
        to[short] node[near start,above=0.25cm,circ] {} (TZ);%
        \draw (16,\yzm) to[short,*-] (\xtransformerp,\yzm) to[short] (TZ);%
