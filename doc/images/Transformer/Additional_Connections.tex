...
\begin{tikzpicture}[%
  ...
  \begin{scope}[local bounding box=Yy2, shift={(0,0)}]
    \ctikzset{poles/full fill opacity=0};%
    \pic[transparent] at (0,0) {Y};%
    \pic[transparent] at (0,-3.5) {y};%
  \end{scope}
  ;%
  \node[left=0.1 of Yy2] (Yy2 legend) {\phantom{Yy2}};%
  \begin{scope}[local bounding box=Dd2, shift={(8,0)}]
    \pic at (0,0) {D inverse};%
    \pic at (0,-3.5) {d direct};%
  \end{scope}
  \node[left=0.1 of Dd2] (Dd2 legend) {\textcolor{red}{Dd}2};%
  \begin{scope}[local bounding box=Dz2, shift={(16,0)}]
    \pic at (0,0) {D inverse};%
  ...
  \begin{scope}[local bounding box=Yy4, shift={(0,-8)}]
    \ctikzset{poles/full fill opacity=0};%
    \pic[transparent] at (0,0) {Y};%
    \pic[transparent] at (0,-3.5) {y};%
  \end{scope}
  ...
  \begin{scope}[local bounding box=Dd4, shift={(8,-8)}]
    \pic at (0,0) {D direct};%
    \pic at (0,-3.5) {d inverse};%
  \end{scope}
  \node[left=0.1 of Dd4] (Dd4 legend) {\textcolor{red}{Dd}4};%
  \begin{scope}[local bounding box=Dz4, shift={(16,-8)}]
    \pic at (0,0) {D direct};%
  ...
  \begin{scope}[local bounding box=Yy8, shift={(0,-24)}]
    \ctikzset{poles/full fill opacity=0};%
    \pic[transparent] at (0,0) {Y};%
    \pic[transparent] at (0,-3.5) {y};%
  \end{scope}
  ...
  \begin{scope}[local bounding box=Dd8, shift={(8,-24)}]
    \pic at (0,0) {D inverse};%
    \pic at (0,-3.5) {d direct reverse};%
  \end{scope}
  \node[left=0.1 of Dd8] (Dd8 legend) {\textcolor{red}{Dd}8};%
  \begin{scope}[local bounding box=Dz8, shift={(16,-24)}]
    \pic at (0,0) {D inverse};%
    \pic at (0,-3.5) {z direct reverse};%
  \end{scope}
  ...
  \begin{scope}[local bounding box=Yy10, shift={(0,-32)}]
    \ctikzset{poles/full fill opacity=0};%
    \pic[transparent] at (0,0) {Y};%
    \pic[transparent] at (0,-3.5) {y};%
  \end{scope}
  ...
  \begin{scope}[local bounding box=Dd10, shift={(8,-32)}]
    \pic at (0,0) {D direct};%
    \pic at (0,-3.5) {d inverse};%
  \end{scope}
  \node[left=0.1 of Dd10] (Dd10 legend) {\textcolor{red}{Dd}10};%
  \begin{scope}[local bounding box=Dz10, shift={(16,-32)}]
    \pic at (0,0) {D direct};%
    \pic at (0,-3.5) {z inverse};%
  \end{scope}
  ...
  \node[left=3.0 of Yy2, node font=\Large] (C2) {2};%
  \node[left=3.0 of Yy4, node font=\Large] (C4) {4};%
  \node[left=3.0 of Yd7, node font=\Large] (C7) {7};%
  \node[left=3.0 of Yy8, node font=\Large] (C8) {8};%
  \node[left=3.0 of Yy10, node font=\Large] (C10) {10};%

  % Add clock numbers coordinates to align the horizontal separators
  \coordinate[left=1.0 of C2] (C2l);%
  \coordinate[left=1.0 of C4] (C4l);%
  \coordinate[left=1.0 of C7] (C7l);%
  \coordinate[left=1.0 of C8] (C8l);%
  \coordinate[left=1.0 of C10] (C10l);%
  ...
  % Add coordinates of the top-left and the bottom-left corners
  \coordinate[above=3.0 of C2] (tl);%
  \coordinate[below=3.0 of C10] (bl);%
  ...
  \draw ($(tl.north east)!0.5!(Yy2.north west)$) -- ($(bl.south east)!0.5!(Yy10.south west)$);%
