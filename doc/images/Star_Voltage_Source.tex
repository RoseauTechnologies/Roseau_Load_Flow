...
\begin{tikzpicture}[%
    ...
    % Lines
    \draw (A) to[short,*-] (A1) to[vsourcesin, v<=$\underline{U_{\arm\nrm}}$, -*] (N);%
    \draw (B) to[short,*-] (B1) to[vsourcesin, v<=$\underline{U_{\brm\nrm}}$, -*] (N);%
    \draw (C) to[short,*-] (C1) to[vsourcesin, v<=$\underline{U_{\crm\nrm}}$, -*] (N);%
