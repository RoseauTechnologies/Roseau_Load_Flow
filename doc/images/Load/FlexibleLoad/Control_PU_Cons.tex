...
\begin{tikzpicture}[%
  ...
  \begin{axis}
    ...
    y tick label style={/pgf/number format/.cd,%
      ...
      fixed,%
      % fixed zerofill,%
      precision=1,use comma},xmin=\xminnormvaleur,xmax=\xmaxnormvaleur,ymin=\yminnormvaleur,ymax=\ymaxnormvaleur,legend
    columns=2,legend style={at={(0.5,-0.25)},anchor=north,nodes={text width=4cm}},cycle list/YlOrRd-5, cycle list
    name=YlOrRd-5]%%%%%%%%%%%%%% initialize YlOrRd-5%
