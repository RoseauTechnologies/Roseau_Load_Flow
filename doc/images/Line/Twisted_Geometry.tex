...
\begin{tikzpicture}[%
  ...
  \begin{scope}[local bounding box=dessin]
    ...
    % Terre
    %
    \filldraw[color=DarkGray] (-5,0) rectangle (5,0.5);%
    ...
    \draw[fill=red] (n center) circle[radius=0.90];%
    ...
    \foreach \x/\y/\z in {a/135/$\arm$,b/45/$\brm$,c/-90/$\crm$} {%
        ...
        \draw[fill=RoseauGreen] (\x\space center) circle[radius=1.4];%
