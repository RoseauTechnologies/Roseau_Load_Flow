...
% Variables
% badness-lint skip redundant-script-braces: \max expands to \mathop, breaks bare U^\max
\newcommand{\umax}{\ensuremath{U^{\max}}}%
\newcommand{\umaxnorm}{\ensuremath{U^{\max\,\text{norm.}}}}%
% badness-lint skip redundant-script-braces: \min expands to \mathop, breaks bare U^\min
...
% badness-lint skip redundant-script-braces: \max expands to \mathop, breaks bare S^\max
\newcommand{\smax}{\ensuremath{S^{\max}}}%
% badness-lint skip redundant-script-braces: \max expands to \mathop, breaks bare P^\max
